...
{
    public class LPC_USART_Fix : UARTBase, IDoubleWordPeripheral, IKnownSize, IProvidesRegisterCollection<DoubleWordRegisterCollection>
    {
        public LPC_USART_Fix(IMachine machine, ulong clockFrequency = DefaultClockFrequency) : base(machine)
        {
